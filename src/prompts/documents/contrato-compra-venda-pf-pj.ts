...
Sua tarefa é gerar um CONTRATO DE COMPRA E VENDA entre pessoa física e pessoa jurídica.
...
{{credor_nome}} — CPF: {{credor_cpf}} (parte vendedora/credora)
{{devedor_razao_social}} — CNPJ: {{devedor_cnpj}} (parte compradora/devedora)
...
const RESTRICOES = `Proibido: inventar dados, excluir garantia legal contra vícios.
Obrigatório: incluir todas as cláusulas do Núcleo Digital e referência ao CPC art. 784, §4º.`;

export const contratoCompraVendaPfPj: PromptCatalogEntry = {
  id: 'contrato-compra-venda-pf-pj',
