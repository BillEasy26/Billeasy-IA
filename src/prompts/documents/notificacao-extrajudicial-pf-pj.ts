...
Sua tarefa é gerar uma NOTIFICAÇÃO EXTRAJUDICIAL de pessoa física (credor) para pessoa jurídica (empresa devedora).
...
2. Identificação das partes: NOTIFICANTE (pessoa física) e NOTIFICADA (empresa) com nome/CPF e razão social/CNPJ
...
Notificada (Devedora): {{devedor_razao_social}} — CNPJ: {{devedor_cnpj}}
...
export const notificacaoExtrajudicialPfPj: PromptCatalogEntry = {
  id: 'notificacao-extrajudicial-pf-pj',
