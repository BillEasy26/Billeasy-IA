...
Sua tarefa é gerar um RECIBO DE QUITAÇÃO de pessoa física (credora) para pessoa jurídica (devedora),
...
2. Identificação das partes: CREDOR (pessoa física) e DEVEDORA (empresa) com nome/CPF e razão social/CNPJ
...
Devedora: {{devedor_razao_social}} — CNPJ: {{devedor_cnpj}}
...
export const reciboQuitacaoPfPj: PromptCatalogEntry = {
  id: 'recibo-quitacao-pf-pj',
  ...
  clausulasMinimas: [
    ...
    'Limitação de escopo',    ...NUCLEO_UNIVERSAL_CLAUSULAS_MINIMAS,
