...
Sua tarefa é gerar uma CONFISSÃO DE DÍVIDA entre duas pessoas jurídicas (empresas),
onde o devedor reconhece formalmente a existência e o valor da dívida.
...
3. Declaração expressa do devedor reconhecendo a dívida (origem e valor)
4. Condições de pagamento (à vista ou parcelado conforme dados fornecidos)
...
export const confissaoDividaPjPj: PromptCatalogEntry = {
  id: 'confissao-divida-pj-pj',
  ...
  clausulasMinimas: [
    ...
    'Encargos por atraso',
    'Vencimento antecipado',    ...NUCLEO_UNIVERSAL_CLAUSULAS_MINIMAS,
